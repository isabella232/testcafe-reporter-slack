...
exports["default"] = function () {
  return {
    ...
    reportTaskStart: function reportTaskStart(startTime, userAgents, testCount) {
      ...
      var meta = "";
      if (process.env.TESTCAFE_HOST) {
        meta += (0, _utilsTextFormatters.bold)("Host:") + " " + process.env.TESTCAFE_HOST + "\n";
      }

      if (process.env.REVISION) {
        meta += (0, _utilsTextFormatters.bold)("Revision:") + " " + process.env.REVISION + "\n";
      }
